...
const categories = {
  ...
  配件: [
    ...
    { fullName: '*Snano 配件擴香片(片)半成品', shortName: 'Snano 擴香片' },
    { fullName: '健康燈系列-E27節律球泡燈(顆)', shortName: '節律球泡燈' },
    { fullName: '健康燈系列-節律照明控制器(個)', shortName: '節律控制器' },
    { fullName: '健康燈系列-LED驅動器(60W無風扇) (LPV-60-24)(個)', shortName: 'LED驅動器' },
    ...
    { fullName: 'Smini 配件吸頂/壁掛(1個), 台灣版', shortName: 'Smini 吸頂/壁掛' },
